...
Secondary change is hashing user's private data. At the moment, user's passwords are stored in plain text. This is a profound security risk. User's passwords would get exposed in case of an unauthorized breakage into the database. Implementation of modern, robust hashing algorithms would significantly improve user base trust, and security by reducing the risk of password theft. 
